...
files = "C:/Users/saman/OneDrive/Documentos/SCRUM/23112021/AsisAuto/*"
output = pd.DataFrame()
...
for file in glob.glob(files):
    ...
    output_2.to_csv("C:/Users/saman/OneDrive/Documentos/SCRUM/23112021/AsisAuto/asistencia.csv")