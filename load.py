...
print(filenameH)
filenameTemp = str(filenameH)
namedir = filenameTemp[15:28]"""
filename = r"C:\Users\saman\OneDrive\Documentos\SCRUM\09112021\09112021_SLC.xls"
#+namedir+"/"+filenameTemp
...
for row in range(0, sheet.nrows):
    ...
    today = datetime.now()
    #today = "2020-10-27" # Para cargar fechas anteriores. Solo contingencia. EN today_date, PONER SOLO today
    today_date = str(today.date()) # Se cambia a esta línea, cuando son datos actuales
    ...
    today_date_N = today_date + "_W0911"
